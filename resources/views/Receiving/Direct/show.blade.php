            ...
            <div class="tile-body">
                <div class="row">
                  <div class="col">
                      ...
                      <span style="font-size: 20px; font-weight: bold">{{ $receiving['site']->job_describe }} </span>
                  </div>
              </div><hr>
              <div class="row container">
                  <div class="col">
                      <span style="font-size: 20px; font-weight: bold"></i> Warehouse -</span>
                      <span style="font-size: 20px; font-weight: bold">{{ strtoupper($receiving['warehouse']->name) }} </span>
                  </div>
              </div><br>
              @php $count = 0; @endphp
              @foreach($receiving['requestItems'] as $item)
