            ...
            <div class="tile-body">
              {{-- <form class="form-horizontal"> --}}
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                  <input class="form-control" type="text" value="{{ old('customer_desc')}}" name="customer_desc" placeholder="Enter Customer Name" autocomplete="off">
                     @error('customer_desc')
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                 <input class="form-control" type="text" value="{{ old('designation')}}" name="designation" placeholder="Enter Designation" autocomplete="off">
                     @error('designation')
                    <span class="invalid-feedback d-block" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" value="{{ old('gstin')}}" name="gstin" placeholder="Enter GSTIN" autocomplete="off">
                     @error('gstin')
                    <span class="invalid-feedback d-block" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
                ...
                @endforeach
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-md-8">
                   <input class="form-control" type="text" value="{{ old('postal_code')}}" name="postal_code" placeholder="Enter Postal-Address" autocomplete="off">
                     @error('postal_code')
                    <span class="invalid-feedback d-block" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
          ...
          <div class="tilk">
            <div class="tile-body">
              {{-- <form class="form-horizontal"> --}}
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" value="{{ old('pan_number')}}"  id="pan_number" name="pan_number" placeholder="Enter Pan No." autocomplete="off">
                     @error('pan_number')
                    <span class="invalid-feedback d-block" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text"  value="{{ old('vat')}}" id="" name="vat" placeholder="Enter Vat" autocomplete="off">
                     @error('vat')
                    <span class="invalid-feedback d-block" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" value="{{ old('contact1')}}" name="contact1" placeholder="Enter Contact No" autocomplete="off">
                     @error('contact1')
                    <span class="invalid-feedback d-block" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" value="{{ old('contact2')}}" name="contact2" placeholder="Enter Contact No." autocomplete="off">
                     @error('contact2')
                    <span class="invalid-feedback d-block" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="text" value="{{ old('address')}}" name="address" placeholder="Enter  Address" autocomplete="off">
                     @error('address')
                    <span class="invalid-feedback d-block" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-md-8">
                  <textarea class="form-control" name="notes"  rows="4" placeholder="Enter Details" autocomplete="off">{{ old('notes')}}</textarea>
                     @error('notes')
                    <span class="invalid-feedback d-block" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
